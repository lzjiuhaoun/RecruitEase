...
import cn.lzj66.service.UserService;
...
public class UserController {
    ...
    public APIResponse updateUserInfo(User user) throws IOException {
        ...
        if(tmpUser.getRole().equals(String.valueOf(User.NormalUser)) || tmpUser.getRole().equals(String.valueOf(User.CompanyUser))){
    ...
    public APIResponse updatePwd(String userId, String password, String newPassword) throws IOException {
        User user =  userService.getUserDetail(userId);
        if(user.getRole().equals(String.valueOf(User.NormalUser)) || user.getRole().equals(String.valueOf(User.CompanyUser))) {
