        ...
        <div style="position: relative;">
          <div class="thing-infos-view">
            <div class="thing-infos">
              ...
              <div v-if="route.query.sort != 2" class="thing-info-box">
                ...
                <template v-if="userStore.user_role !== '0'">
            ...
            <div class="thing-counts hidden-sm">
              <div v-if="route.query.sort != 2" class="count-item flex-view pointer" @click="addToWish()">
                <div class="count-img">
                  <img :src="WantIcon">
                </div>
...
onMounted(() => {
  ...
  sortId.value = route.query.sort.trim()
  getThingDetail()
  getRecommendThing()
  getCommentList()
})
...
const getThingDetail = () => {
  detailApi({ id: thingId.value, sort: sortId.value }).then(res => {
