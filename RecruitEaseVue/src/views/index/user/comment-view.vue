        ...
        <a-spin :spinning="loading" style="min-height: 200px;">
          <div class="comment-list">
            <div class="comment-item flex-view" v-for="item in commentData">
              <img v-if="item.cover !== BASE_URL + '/api/staticfiles/image/null'" :src="item.cover" class="avatar">
              <img v-else :src=MyOrderImg class="avatar">
              <div class="infos">
...
const handleClickTitle =(record)=> {
  let text = router.resolve({name: 'detail', query: {id: record.thingId, sort: record.sort}})
