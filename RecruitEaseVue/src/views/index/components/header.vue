      ...
      <template v-if="userStore.user_token">
        <a-dropdown>
          <a class="ant-dropdown-link" @click="e => e.preventDefault()">
            <img v-if="userInfo.avatarURL" :src="userInfo.avatarURL" class="self-img">
            <img v-else :src="AvatarIcon" class="self-img">
          </a>
          <template #overlay>
            <a-menu>
              <a-menu-item>
                <a v-if="userStore.user_role === '1'" @click="goUserCenter('resumeEditView')">求职中心</a>
                <a v-else @click="goUserCenter('myCompanyView')">公司信息</a>
              </a-menu-item>
              <a-menu-item>
